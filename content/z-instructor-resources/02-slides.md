...
Below are some example slides to show the formatting that can be done in this presentation. Each slide is present in the [Slides]({{< relref "/z-instructor-resources/02-slides-example.md" >}}) page.
